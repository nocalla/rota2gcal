...
g_shifts = {
    "9--6": "Early", "10--7": "Middle", "11--8": "Late",
            ...
            "9--5": "Early Short", "12--8": "Late Short",
            "10--6": "Middle Short",
...
def get_credentials():
    # Google Calendar API Credential stuff - don't mess with!
...
def get_rota(dir):
    ...
    """
    files = list()
    files_string = ("Choose file to import data from by entering "
                    "relevant number:\n")
...
def convert_day(wkstart, day, times):
    ...
    if "--" in times:
        ...
        try:
            ...
            all_day = True
        """
        hack here to account for weird formats
        after the regular time notation
        """
        try:
...
class Rota_Calendar(object):
    ...
    def write_to_cal(self, dict, name, t_cal, prefix):
        ...
        if cal_details:
            ...
            with open("last_calendar_output.txt", "w") as f:
